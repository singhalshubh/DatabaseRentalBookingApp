<?php 
  ...
  $query = <<<EOD
SELECT name,time,date,pickLoc,dropLoc,driverName,model FROM booking b,drivers d,cars c WHERE b.carId=c.carId AND b.driverId=d.driverId AND b.bookingId=$bookingId; 
EOD;
...
function initMap() {
 ...
 <header style="box-shadow: 10px; padding-top: 3%;"> 
  ...
  <div class="d2">
    Time of booking : <?php echo($responseArray[0]["time"]); ?><br>
    Pickup Location : <?php echo($responseArray[0]["pickLoc"]); ?><br>
    Drop Location : <?php echo($responseArray[0]["dropLoc"]); ?><br>
    Driver Name : <?php echo($responseArray[0]["driverName"]); ?><br>
    Car Model : <?php echo($responseArray[0]["model"]); ?>
  </div>
